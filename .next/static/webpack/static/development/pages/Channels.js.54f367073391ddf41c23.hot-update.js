...
var Channels = /*#__PURE__*/function (_React$Component) {
  ...
  Object(_babel_runtime_helpers_esm_createClass__WEBPACK_IMPORTED_MODULE_1__["default"])(Channels, [{
    ...
    value: function render() {
      ...
      }, "Stop"), console.log("name: ".concat(this.state.name, ", url: ").concat(this.state.url, ", playing: ").concat(this.state.playing)), __jsx("hr", {
        className: "hr",
        __self: this,
        __source: {
          fileName: _jsxFileName,
...
//# sourceMappingURL=Channels.js.54f367073391ddf41c23.hot-update.js.map